 ...
 *
 * Provenance: https://ui.shadcn.com/r/styles/new-york/dropdown-menu.json
 * Fetched:    2026-07-26 · Licence: MIT (shadcn/ui)
 *
 * LOCAL MODIFICATIONS:
 *   Hover/focus/open state backgrounds remapped from --accent to --muted
 *   (data-[state=open]:bg-accent, focus:bg-accent, focus:text-accent-foreground). shadcn treats --accent as a SUBDUED
